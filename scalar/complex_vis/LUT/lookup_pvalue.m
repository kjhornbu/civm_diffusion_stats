...
if  nnz(strcmp(type,{'pvalue_extended','pvalue'}))
    ...
    temp3=mean(colors(4:5,:));
    temp2=mean(colors(3:4,:));
    temp1=mean(colors(2:3,:));

    colors(6,:)=[186,186,186];
    colors(5,:)=temp3;
    colors(4,:)=temp2;
    colors(3,:)=temp1;
    colors(2,:)=colors(1,:);
...
if nnz(strcmp(type,{'pvalue_extended','pvalue_0p1_extended'}))
...
color_names= vertcat(color_names,gray_names);
