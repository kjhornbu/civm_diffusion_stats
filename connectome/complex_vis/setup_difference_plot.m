function [figure_entries,make_lut_img] = setup_difference_plot(directory,vertex,selection_pull,matrix_2_print,idx_vertex_10pct_noUncharted_inOntologyOrder,difference_criteria,ontology_Order,make_lut_img)
%% Find only Key Regions within data
%the positional_idx_region is in the order of strength of difference? 
% Filter out Zero idxs
positional_idx=find(idx_vertex_10pct_noUncharted_inOntologyOrder);
