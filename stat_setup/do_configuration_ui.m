function [keep_last_setup] = do_configuration_ui(setup_file)
...
uil=uilabel(main_grid,'text',sprintf(['A configuration file exists for this project at: %s.\n\n' ...
    'DO YOU WANT TO MAKE A NEW CONFIGURATION FILE?'],setup_file));
