...
mkdir(fullfile(working_folder,'MDS_plots'));
mkdir(fullfile(working_folder,'MDS_plots','Regional'));
mkdir(fullfile(working_folder,'MDS_plots','Global'));
...
civm_write_table(output_regional,fullfile(working_folder,'MDS_plots','Regional','REGIONAL_MDS_centroid_to_centroid_Distance_All+AgeGroup.csv'));
civm_write_table(output_global_overall,fullfile(working_folder,'MDS_plots','Global','GLOBAL_MDS_centroid_to_centroid_Distance_All+AgeGroup.csv'));
