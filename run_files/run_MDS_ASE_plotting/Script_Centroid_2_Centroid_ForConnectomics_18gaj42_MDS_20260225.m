...
print(f, fullfile('Z:\All_Staff\18.gaj.42\',strcat('2026_03_02_Global_MDS_plot_withCentroid2Centroid.svg')),'-dsvg','-vector');
...
print(f, fullfile('Z:\All_Staff\18.gaj.42\',strcat('2026_03_02_Global_MDS_plot.svg')),'-dsvg','-vector');
...
for n=1:height(strain)
    ...
    print(f, fullfile('Z:\All_Staff\18.gaj.42\',strcat('2026_03_02_Global_MDS_plot',strain{n},'.svg')),'-dsvg','-vector');
...
for n=1:height(strain)
    ...
    print(f, fullfile('Z:\All_Staff\18.gaj.42\',strcat('2026_03_02_Global_MDS_plot',strain{n},'_withCentroid2Centroid.svg')),'-dsvg','-vector');
...
for n=1:numel(values_T)
    ...
    for m=1:height(temp_out)
        ...
        if strcmp(temp_out.compare{m},'Old')
            plot(temp_indiv_data.X1/s_regional_vertex(1,values_T(n)),temp_indiv_data.X2/s_regional_vertex(2,values_T(n)),'o','MarkerFaceColor', [0.4660 0.6740 0.1880],'MarkerEdgeColor',[1 1 1],'MarkerSize',6);
        elseif strcmp(temp_out.compare{m},'Young')
            plot(temp_indiv_data.X1/s_regional_vertex(1,values_T(n)),temp_indiv_data.X2/s_regional_vertex(2,values_T(n)),'o','MarkerEdgeColor',[0.4940 0.1840 0.5560],'MarkerSize',6);
        end
...
yticks([-12, -9, -6, -3, 0, 3, 6, 9, 12]);
    ...
    if values_T(n)>180
        print(f, fullfile('Z:\All_Staff\18.gaj.42\',strcat('Regional_MDS_plot_ROI_',num2str(values_T(n)-180+1000),'_indivstd.svg')),'-dsvg','-vector');
    else
        print(f, fullfile('Z:\All_Staff\18.gaj.42\',strcat('Regional_MDS_plot_ROI_',num2str(values_T(n)),'_indivstd.svg')),'-dsvg','-vector');
    end
end
...
yticks([-12, -9, -6, -3, 0, 3, 6, 9, 12]);
    ...
    if values_T(n)>180
        print(f, fullfile('Z:\All_Staff\18.gaj.42\',strcat('Regional_MDS_plot_ROI_',num2str(values_T(n)-180+1000),'_withCentroid2Centroid_indivstd.svg')),'-dsvg','-vector');
    else
        print(f, fullfile('Z:\All_Staff\18.gaj.42\',strcat('Regional_MDS_plot_ROI_',num2str(values_T(n)),'_withCentroid2Centroid_indivstd.svg')),'-dsvg','-vector');
    end
end

civm_write_table(output_regional,'Z:\All_Staff\18.gaj.42\REGIONAL_MDS_Indiv_STD_centroid_to_centroid_Distance_All_Strains+All.csv');
