...
cleaned_google_doc_path=fullfile(project_dir,'Edited_24chdi01Phase2_lightsheet_20260512.txt');
cleaned_google_doc_path=fullfile(project_dir,'Edited_24chdi01Phase2_lightsheet_20260512-6m.txt');


statSaveDir=fullfile(project_dir,'6m-20260512/');
...
dataframe_path=fullfile(statSaveDir, '24chdi01Phase2_20260512_lightsheet.txt');
config_file='';
polished_sheets=fullfile(project_dir,'polished_sheets'); %where the polished sheets will be saved
project_research_archive{1}=fullfile('B:/',studyID,'ls_native_stats','n4Normalized','raw_stats');
