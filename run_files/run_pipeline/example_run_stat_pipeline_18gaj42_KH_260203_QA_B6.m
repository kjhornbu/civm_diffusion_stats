...
cleaned_google_doc_path=fullfile(project_dir,'google_sheet_captures',strcat('Edited_GoogleSheet_YoungB6_ProtocolSheet_',char(datetime('today')),'.txt'));
%if the day has changed since you ran this you want to make sure you set this to the fixed path!!!

dataframe_path=fullfile(project_dir, ['YoungB6_From_18gaj42_17gaj40_21QA94TAgilent01_DataFrame_Windows_ProtocolSheet_',char(datetime('today')),'.txt']);
