...
% 
% google_doc=civm_read_table(google_doc);
% google_doc.Age=[];
% 
% civm_write_table(google_doc,"Z:\All_Staff\18.gaj.42\google_sheet_captures\18.gaj.42_20260401.txt");


cleaned_google_doc_path=fullfile(project_dir,'google_sheet_captures',strcat('Edited_GoogleSheet_FixedDate.txt'));%,char(datetime('today')),'
%if the day has changed since you ran this you want to make sure you set this to the fixed path!!!

dataframe_path="Z:\All_Staff\18.gaj.42\18.gaj.42_DataFrame_noB6_20260224v2.txt";
...
save_dir=fullfile(project_dir,'FullAnalysis_20260401Test');
