...
project_dir='B:\20.5xfad.02\QA_Studies_Scalar_Stats\SE_v_FSE';

google_doc=fullfile(project_dir,'google_sheet_caps','21QA94TAgilent_20260216_WithWyattNotes_SevFSE.txt');

cleaned_google_doc_path=fullfile(project_dir,'google_sheet_caps',strcat('Edited_GoogleSheet_From21QA94TAgilent_20260216_WithWyattNotes_SevFSE.txt'));
