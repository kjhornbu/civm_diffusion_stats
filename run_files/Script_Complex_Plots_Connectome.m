...
%selection=list2cell('Phase');
%selection=list2cell('scanner');
...
selection_pull=list2cell('B6-5XFAD AD-BXD77 AD-BXD65 AD-BXD32');
%selection_pull=list2cell('All Phase1 Phase2');
%selection_pull=list2cell('All Agilent MRS');
compare_group_A='nTG';
compare_group_B='FAD';
...
%directory="Z:\All_Staff\20.5xFAD.02\Test_Img_Generation";
directory="Z:\All_Staff\20.5xFAD.02\Test_StrainStrat_Img_Generation";
%directory="Z:\All_Staff\20.5xFAD.02\Test_PhaseCompare_250915";
%directory="Z:\All_Staff\20.5xFAD.02\Test_scannerCompare_250915";
%directory="Z:\All_Staff\20.5xFAD.02\Testv250915";
make_Left_Axis=1;
make_LUT_img=1;
...
%all_sig_pvalues=[1:174,176:180]; %for all strain combo
