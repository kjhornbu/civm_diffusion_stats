%% Note the major difference between this file and example_run_file_cloudnotebookui_...
% editior_20x5xFaD02_stratified is the setup file. 
% You specify if there is stratification in the GUI now that comes up while
% setting up the run.
